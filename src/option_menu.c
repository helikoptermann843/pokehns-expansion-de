...
static const u8 gText_BattleStyleSet[]     = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FEST");
...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    [MENUITEM_BUTTONMODE]  = COMPOUND_STRING("STEUERUNG"),
    [MENUITEM_FRAMETYPE]   = COMPOUND_STRING("RAHMEN"),
    [MENUITEM_CANCEL]      = COMPOUND_STRING("ZURÜCK"),
};
