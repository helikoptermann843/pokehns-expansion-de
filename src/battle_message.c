...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_AVOIDEDDAMAGE]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} vermeidet\nSchaden mit {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNWASDEFROSTED2]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde\naufgetaut!"),
    ...
    [STRINGID_PKMNUPROARKEPTAWAKE]                  = COMPOUND_STRING("AUFRUHR von {B_SCR_NAME_WITH_PREFIX}\nhält es wach!"),
    ...
    [STRINGID_PKMNCANTSLEEPINUPROAR]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} kann bei dem\nAUFRUHR nicht schlafen!"),
    ...
    [STRINGID_PKMNSENTTOPC]                         = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} wurde auf\n{B_PC_CREATOR_NAME} PC übertragen."), //Still used lanette's pc since terminology is different
    ...
    [STRINGID_PKMNMAKESGROUNDMISS]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wehrt BODEN-\nAttacken mit {B_DEF_ABILITY} ab!"), //not in gen 5+, ability popup
	...
	[STRINGID_PSNBYITEM]                            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} wurde stark durch das {B_LAST_ITEM} vergiftet!"),
	[STRINGID_BRNBYITEM]                            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} wurde durch das {B_LAST_ITEM} verbrannt!"),
	[STRINGID_DEFABILITYIN]                         = COMPOUND_STRING("Die {B_DEF_ABILITY} von {B_DEF_NAME_WITH_PREFIX} wird aktiviert!"),
	...
	[STRINGID_SWITCHEDATKANDSPATK]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} tauschte alle Änderungen von Angriff und Spezial-Angriff mit dem Ziel!"),
	[STRINGID_SWITCHEDDEFANDSPDEF]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} tauschte alle Änderungen von Verteidigung und Spezial-Verteidigung mit dem Ziel!"),
	...
	[STRINGID_PKMNACQUIREDSIMPLE]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} erhielt Simple!"),
	...
	[STRINGID_RESTORETARGETSHEALTH]                 = COMPOUND_STRING("HP von {B_DEF_NAME_WITH_PREFIX} wurde wiederhergestellt!"),
	[STRINGID_TOOKPJMNINTOTHESKY]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} nahm {B_DEF_NAME_WITH_PREFIX2} in die Luft!"),
	[STRINGID_FREEDFROMSKYDROP]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wurde vom Sky Drop befreit!"),
	[STRINGID_POSTPONETARGETMOVE]                   = COMPOUND_STRING("Der Zug von {B_DEF_NAME_WITH_PREFIX} wurde verschoben!"),
	...
	[STRINGID_MAGICBOUNCEACTIVATES]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} reflektierte {B_ATK_NAME_WITH_PREFIX2}!"),
	...
	[STRINGID_SWEETVEILPROTECTED]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} kann wegen des süßen Schleiers nicht einschlafen!"),
	...
	[STRINGID_PKMNSENTTOPCAFTERCATCH]               = gText_PkmnSentToPCAfterCatch, // bleibt unverändert, da bereits definiert
...
static const u8 sText_InGamePartnerWithdrewPkmn2[] = _("{B_PARTNER_NAME_WITH_CLASS} komm zurück {B_PLAYER_MON2_NAME}!");
