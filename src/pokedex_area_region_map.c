...
static const u32 sPokedexAreaMap_Gfx_Johto[]     = INCBIN_U32("graphics/pokedex/johto_region_map.8bpp.smol");
static const u32 sPokedexAreaMap_Tilemap_Johto[] = INCBIN_U32("graphics/pokedex/johto_region_map.bin.smolTM");
