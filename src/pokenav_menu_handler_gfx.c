...
{
    [POKENAV_MENUITEM_MAP]                     = COMPOUND_STRING("Erforsche die Karte von JOHTO"),
    ...
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("POKéGEAR weglegen."),
    ...
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Zurück zum POKéGEAR-Menü."),
